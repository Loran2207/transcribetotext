import svgPaths from "./svg-gvuzhw0i97";
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col h-[112px] items-start left-[30.28px] pl-[-7.365px] pr-[-7.366px] pt-[-5.579px] top-[15.29px] w-[88px]" data-name="Container">
      <Container1 />
    </div>
  );
}
...
function Icon3() {
  return (
    <div className="h-[16px] overflow-clip relative shrink-0 w-full" data-name="Icon">
      ...
      <div className="absolute inset-[9.99%_2.33%_67.51%_76.74%]" data-name="Vector">
      ...
      <div className="absolute inset-[37.5%_44.19%_17.5%_27.9%]" data-name="Vector">
      ...
      <div className="absolute inset-[37.5%_46.51%_15%_27.9%]" data-name="Vector">
      ...
      <div className="absolute inset-[37.5%_46.51%_20%_27.9%]" data-name="Vector">
      ...
      <div className="absolute inset-[37.5%_48.84%_20%_27.9%]" data-name="Vector">
...
function Container3() {
  return (
    <div className="absolute bg-white h-[34px] left-0 rounded-[6px] top-[-0.4px] w-[86px]" data-name="Container">
      <GoogleMeetIcon />
      <ZoomIcon />
      <TeamsIcon />
    </div>
