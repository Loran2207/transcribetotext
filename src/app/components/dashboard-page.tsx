...
const tourCard = (modal: "upload" | "record" | "meeting" | "link") => (modal === "record" ? "home-card-record" : modal === "meeting" ? "home-card-meeting" : modal === "upload" ? "home-card-upload" : "home-card-link");
