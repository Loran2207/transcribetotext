...
export function BrandSection() {
  return (
    <SectionFrame
      ...
      group="Foundations"
      title="Brand"
      description="The wordmark sets TRANSCRIBE + TEXT. in heavy weight with a lighter TO bridge; the period is part of the mark. The bubble holds AI over a teal→blue gradient. Use the mark alone only at small sizes."
    >
      <SubBlock label="Logo">
      ...
      <SubBlock label={`Brand gradient · ${brandGradient.angle}`}>
        <div className="flex flex-wrap items-center gap-5">
          <span
            className="h-[70px] w-[128px] rounded-[14px]"
