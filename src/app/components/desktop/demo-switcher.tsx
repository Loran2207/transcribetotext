...
const GROUPS: { title: string; key: string; kind: "local" | "session"; options: { value: string; label: string }[] }[] = [
  ...
  { title: "Desktop banner on the web", key: "ttt_demo_banner", kind: "session", options: [{ value: "", label: "Block in the navigation" }, { value: "panel", label: "Right panel card" }, { value: "home", label: "Wide banner under the cards" }] },
