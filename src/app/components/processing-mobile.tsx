    ...
    <>
      {!open && createPortal(
        ...
        >
          ...
          {badgeCount > 0 && (
            <span className={"absolute -top-[6px] -right-[6px] min-w-[20px] h-[20px] px-[5px] rounded-full text-[11px] font-semibold flex items-center justify-center text-white " + (badgeIsError ? "bg-destructive" : "bg-primary")}>
              {badgeCount}
            </span>
          )}
        </button>,
