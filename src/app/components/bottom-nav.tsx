    ...
    <Drawer open={createOpen} onOpenChange={setCreateOpen}>
      <DrawerTrigger asChild>
        <button
          ...
          data-mobile-fab="add"
          className={`lg:hidden fixed z-[45] flex items-center justify-center rounded-full bg-primary text-primary-foreground active:scale-95 transition-all motion-reduce:transition-none motion-reduce:active:scale-100 ${fabHidden ? "opacity-0 translate-y-3 pointer-events-none" : "opacity-100"}`}
