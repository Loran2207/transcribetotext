...
const dict: Record<string, Record<LangCode, string>> = {
  ...
  "dash.card.instantSpeech": { en: "Instant speech", ru: "\u041c\u0433\u043d\u043e\u0432\u0435\u043d\u043d\u0430\u044f \u0440\u0435\u0447\u044c", es: "Habla instant\u00e1nea", de: "Sofortige Sprache", fr: "Parole instantan\u00e9e", ja: "\u30a4\u30f3\u30b9\u30bf\u30f3\u30c8\u30b9\u30d4\u30fc\u30c1" },
  ...
  "dash.card.transcribeFromLink": { en: "Transcribe from URL", ru: "\u0422\u0440\u0430\u043d\u0441\u043a\u0440\u0438\u043f\u0446\u0438\u044f \u043f\u043e \u0441\u0441\u044b\u043b\u043a\u0435", es: "Transcribir desde enlace", de: "Von Link transkribieren", fr: "Transcrire depuis un lien", ja: "\u30ea\u30f3\u30af\u304b\u3089\u6587\u5b57\u8d77\u3053\u3057" },
  ...
  "table.folder": { en: "Folder", ru: "\u041f\u0430\u043f\u043a\u0430", es: "Carpeta", de: "Ordner", fr: "Dossier", ja: "\u30d5\u30a9\u30eb\u30c0" },
  "table.noFolder": { en: "No folder", ru: "\u0411\u0435\u0437 \u043f\u0430\u043f\u043a\u0438", es: "Sin carpeta", de: "Ohne Ordner", fr: "Sans dossier", ja: "\u30d5\u30a9\u30eb\u30c0\u306a\u3057" },
  "table.addToFolder": { en: "Add to folder", ru: "\u0412 \u043f\u0430\u043f\u043a\u0443", es: "A\u00f1adir a carpeta", de: "In Ordner", fr: "Vers un dossier", ja: "\u30d5\u30a9\u30eb\u30c0\u306b\u8ffd\u52a0" },
  ...
  "share.invite": { en: "Invite", ru: "Пригласить", es: "Invitar", de: "Einladen", fr: "Inviter", ja: "招待" },
  "share.copyLinkHint": { en: "Change access to \"Anyone with link\" to copy", ru: "Измените доступ на «Все по ссылке»", es: "Cambia el acceso a «Cualquiera con enlace»", de: "Zugriff auf «Jeder mit Link» ändern", fr: "Changez l'accès en « Quiconque avec le lien »", ja: "「リンクを持つ全員」に変更してコピー" },
  ...
  "share.anyoneWithLinkCanView": { en: "Anyone with the link can view", ru: "Любой со ссылкой может просматривать", es: "Cualquier persona con el enlace puede ver", de: "Jeder mit dem Link kann ansehen", fr: "Toute personne disposant du lien peut consulter", ja: "リンクを知っている全員が閲覧可能" },
  ...
  "share.demoTitle": { en: "Sharing requires an account", ru: "Для шаринга нужен аккаунт", es: "Compartir requiere una cuenta", de: "Zum Teilen ist ein Konto erforderlich", fr: "Le partage nécessite un compte", ja: "共有にはアカウントが必要です" },
  "share.demoDesc": { en: "Sign up for a free account to share transcriptions and folders with others.", ru: "Зарегистрируйтесь, чтобы делиться транскрипциями и папками.", es: "Regístrate gratis para compartir transcripciones y carpetas.", de: "Erstellen Sie ein kostenloses Konto, um Transkriptionen und Ordner zu teilen.", fr: "Créez un compte gratuit pour partager des transcriptions et des dossiers.", ja: "トランスクリプトやフォルダを共有するには、無料アカウントを作成してください。" },
  "share.signUpToShare": { en: "Sign up to share", ru: "Зарегистрироваться", es: "Regístrate para compartir", de: "Registrieren zum Teilen", fr: "S'inscrire pour partager", ja: "共有するにはサインアップ" },
  ...
  // ── Calendar page ──
  "calendar.title": { en: "Meetings coming next", ru: "\u0411\u043b\u0438\u0436\u0430\u0439\u0448\u0438\u0435 \u0432\u0441\u0442\u0440\u0435\u0447\u0438", es: "Pr\u00f3ximas reuniones", de: "N\u00e4chste Meetings", fr: "Prochaines r\u00e9unions", ja: "\u4eca\u5f8c\u306e\u4f1a\u8b70" },
  "calendar.allCalendars": { en: "All calendars", ru: "\u0412\u0441\u0435 \u043a\u0430\u043b\u0435\u043d\u0434\u0430\u0440\u0438", es: "Todos los calendarios", de: "Alle Kalender", fr: "Tous les calendriers", ja: "\u3059\u3079\u3066\u306e\u30ab\u30ec\u30f3\u30c0\u30fc" },
  "calendar.freeLeft": { en: "free transcriptions left", ru: "\u0431\u0435\u0441\u043f\u043b\u0430\u0442\u043d\u044b\u0445 \u0442\u0440\u0430\u043d\u0441\u043a\u0440\u0438\u043f\u0446\u0438\u0439", es: "transcripciones gratis restantes", de: "kostenlose Transkriptionen \u00fcbrig", fr: "transcriptions gratuites restantes", ja: "\u7121\u6599\u6587\u5b57\u8d77\u3053\u3057\u6b8b\u308a" },
  "calendar.upgrade": { en: "Upgrade", ru: "\u0423\u043b\u0443\u0447\u0448\u0438\u0442\u044c", es: "Mejorar", de: "Upgraden", fr: "Am\u00e9liorer", ja: "\u30a2\u30c3\u30d7\u30b0\u30ec\u30fc\u30c9" },
  "calendar.prevWeek": { en: "Previous week", ru: "\u041f\u0440\u0435\u0434\u044b\u0434\u0443\u0449\u0430\u044f \u043d\u0435\u0434\u0435\u043b\u044f", es: "Semana anterior", de: "Vorherige Woche", fr: "Semaine pr\u00e9c\u00e9dente", ja: "\u524d\u306e\u9031" },
  "calendar.nextWeek": { en: "Next week", ru: "\u0421\u043b\u0435\u0434\u0443\u044e\u0449\u0430\u044f \u043d\u0435\u0434\u0435\u043b\u044f", es: "Semana siguiente", de: "N\u00e4chste Woche", fr: "Semaine suivante", ja: "\u6b21\u306e\u9031" },
  "calendar.today": { en: "Today", ru: "\u0421\u0435\u0433\u043e\u0434\u043d\u044f", es: "Hoy", de: "Heute", fr: "Aujourd'hui", ja: "\u4eca\u65e5" },
  "calendar.autoJoin": { en: "Auto-join", ru: "\u0410\u0432\u0442\u043e-\u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u0435", es: "Auto-unirse", de: "Auto-beitreten", fr: "Auto-rejoindre", ja: "\u81ea\u52d5\u53c2\u52a0" },
  "calendar.meetingsWeek": { en: "meetings this week", ru: "\u0432\u0441\u0442\u0440\u0435\u0447 \u043d\u0430 \u044d\u0442\u043e\u0439 \u043d\u0435\u0434\u0435\u043b\u0435", es: "reuniones esta semana", de: "Meetings diese Woche", fr: "r\u00e9unions cette semaine", ja: "\u4eca\u9031\u306e\u4f1a\u8b70" },
  "calendar.todayAgenda": { en: "Today's Agenda", ru: "\u0421\u0435\u0433\u043e\u0434\u043d\u044f", es: "Agenda de hoy", de: "Heute", fr: "Agenda du jour", ja: "\u4eca\u65e5\u306e\u4e88\u5b9a" },
  "calendar.noMeetingsToday": { en: "No meetings today", ru: "\u041d\u0435\u0442 \u0432\u0441\u0442\u0440\u0435\u0447 \u0441\u0435\u0433\u043e\u0434\u043d\u044f", es: "Sin reuniones hoy", de: "Keine Meetings heute", fr: "Pas de r\u00e9unions aujourd'hui", ja: "\u4eca\u65e5\u306e\u4f1a\u8b70\u306a\u3057" },
  "calendar.thisWeek": { en: "This week", ru: "\u041d\u0430 \u044d\u0442\u043e\u0439 \u043d\u0435\u0434\u0435\u043b\u0435", es: "Esta semana", de: "Diese Woche", fr: "Cette semaine", ja: "\u4eca\u9031" },
  "calendar.hoursTotal": { en: "Hours total", ru: "\u0427\u0430\u0441\u043e\u0432 \u0432\u0441\u0435\u0433\u043e", es: "Horas totales", de: "Stunden gesamt", fr: "Heures au total", ja: "\u5408\u8a08\u6642\u9593" },
  "calendar.noMeetings": { en: "No meetings, just moments for you!", ru: "\u041d\u0435\u0442 \u0432\u0441\u0442\u0440\u0435\u0447, \u0442\u043e\u043b\u044c\u043a\u043e \u0432\u0440\u0435\u043c\u044f \u0434\u043b\u044f \u0441\u0435\u0431\u044f!", es: "\u00a1Sin reuniones, solo tiempo para ti!", de: "Keine Meetings, nur Zeit f\u00fcr dich!", fr: "Pas de r\u00e9unions, juste du temps pour vous !", ja: "\u4f1a\u8b70\u306a\u3057\u3001\u81ea\u5206\u306e\u6642\u9593\u3092\u697d\u3057\u3093\u3067\uff01" },
  "calendar.scheduler": { en: "Scheduler", ru: "\u041f\u043b\u0430\u043d\u0438\u0440\u043e\u0432\u0449\u0438\u043a", es: "Planificador", de: "Planer", fr: "Planificateur", ja: "\u30b9\u30b1\u30b8\u30e5\u30fc\u30e9\u30fc" },
  "calendar.schedulerDesc": { en: "Get meetings scheduled faster and stop wasting time with back-and-forth emails. You stay productive, and your calendar stays full.", ru: "\u041f\u043b\u0430\u043d\u0438\u0440\u0443\u0439\u0442\u0435 \u0432\u0441\u0442\u0440\u0435\u0447\u0438 \u0431\u044b\u0441\u0442\u0440\u0435\u0435 \u0438 \u043f\u0435\u0440\u0435\u0441\u0442\u0430\u043d\u044c\u0442\u0435 \u0442\u0440\u0430\u0442\u0438\u0442\u044c \u0432\u0440\u0435\u043c\u044f \u043d\u0430 \u043f\u0435\u0440\u0435\u043f\u0438\u0441\u043a\u0443.", es: "Programa reuniones m\u00e1s r\u00e1pido y deja de perder tiempo con correos de ida y vuelta.", de: "Planen Sie Meetings schneller und verschwenden Sie keine Zeit mit E-Mails hin und her.", fr: "Planifiez vos r\u00e9unions plus rapidement et arr\u00eatez de perdre du temps avec les \u00e9changes d'e-mails.", ja: "\u4f1a\u8b70\u3092\u7d20\u65e9\u304f\u30b9\u30b1\u30b8\u30e5\u30fc\u30eb\u3057\u3001\u30e1\u30fc\u30eb\u306e\u3084\u308a\u53d6\u308a\u3092\u6e1b\u3089\u3057\u307e\u3057\u3087\u3046\u3002" },
  "calendar.startScheduling": { en: "Start scheduling a meeting", ru: "\u041d\u0430\u0447\u0430\u0442\u044c \u043f\u043b\u0430\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u0435", es: "Empezar a programar", de: "Meeting planen", fr: "Planifier une r\u00e9union", ja: "\u4f1a\u8b70\u3092\u8a08\u753b\u3059\u308b" },
  ...
  "calendar.autoRecordOn": { en: "Auto-record on", ru: "\u0410\u0432\u0442\u043e\u0437\u0430\u043f\u0438\u0441\u044c \u0432\u043a\u043b.", es: "Grabaci\u00f3n auto. activa", de: "Auto-Aufnahme an", fr: "Enregistrement auto. actif", ja: "\u81ea\u52d5\u9332\u97f3\u30aa\u30f3" },
  "calendar.autoRecordOff": { en: "Auto-record off", ru: "\u0410\u0432\u0442\u043e\u0437\u0430\u043f\u0438\u0441\u044c \u0432\u044b\u043a\u043b.", es: "Grabaci\u00f3n auto. inactiva", de: "Auto-Aufnahme aus", fr: "Enregistrement auto. inactif", ja: "\u81ea\u52d5\u9332\u97f3\u30aa\u30d5" },
  "calendar.nextMeeting": { en: "Next Meeting", ru: "\u0421\u043b\u0435\u0434\u0443\u044e\u0449\u0430\u044f \u0432\u0441\u0442\u0440\u0435\u0447\u0430", es: "Pr\u00f3xima reuni\u00f3n", de: "N\u00e4chstes Meeting", fr: "Prochaine r\u00e9union", ja: "\u6b21\u306e\u4f1a\u8b70" },
  "calendar.noUpcomingMeetings": { en: "No upcoming meetings this week", ru: "\u041d\u0435\u0442 \u043f\u0440\u0435\u0434\u0441\u0442\u043e\u044f\u0449\u0438\u0445 \u0432\u0441\u0442\u0440\u0435\u0447", es: "Sin reuniones pr\u00f3ximas esta semana", de: "Keine anstehenden Meetings diese Woche", fr: "Pas de r\u00e9unions \u00e0 venir cette semaine", ja: "\u4eca\u9031\u306e\u4e88\u5b9a\u306a\u3057" },
  "calendar.meetings": { en: "Meetings", ru: "\u0412\u0441\u0442\u0440\u0435\u0447\u0438", es: "Reuniones", de: "Meetings", fr: "R\u00e9unions", ja: "\u4f1a\u8b70" },
  "calendar.meetingTime": { en: "Meeting time", ru: "\u0412\u0440\u0435\u043c\u044f \u0432\u0441\u0442\u0440\u0435\u0447", es: "Tiempo de reuni\u00f3n", de: "Meetingzeit", fr: "Temps de r\u00e9union", ja: "\u4f1a\u8b70\u6642\u9593" },
  "calendar.transcribedCount": { en: "Transcribed", ru: "\u0422\u0440\u0430\u043d\u0441\u043a\u0440\u0438\u0431\u0438\u0440\u043e\u0432\u0430\u043d\u043e", es: "Transcritos", de: "Transkribiert", fr: "Transcrits", ja: "\u6587\u5b57\u8d77\u3053\u3057\u6e08\u307f" },
  "calendar.upcoming": { en: "Upcoming", ru: "\u041f\u0440\u0435\u0434\u0441\u0442\u043e\u044f\u0449\u0438\u0435", es: "Pr\u00f3ximas", de: "Bevorstehend", fr: "\u00c0 venir", ja: "\u4eca\u5f8c" },
  "calendar.weekLoad": { en: "Week Load", ru: "\u041d\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u043d\u0435\u0434\u0435\u043b\u0438", es: "Carga semanal", de: "Wochenauslastung", fr: "Charge semaine", ja: "\u9031\u306e\u8ca0\u8377" },
  "calendar.emptyWeekend": { en: "Enjoy your weekend!", ru: "\u041f\u0440\u0438\u044f\u0442\u043d\u044b\u0445 \u0432\u044b\u0445\u043e\u0434\u043d\u044b\u0445!", es: "\u00a1Disfruta tu fin de semana!", de: "Genie\u00df dein Wochenende!", fr: "Bon week-end !", ja: "\u826f\u3044\u9031\u672b\u3092\uff01" },
  "calendar.clearDay": { en: "Clear day", ru: "\u0421\u0432\u043e\u0431\u043e\u0434\u043d\u044b\u0439 \u0434\u0435\u043d\u044c", es: "D\u00eda libre", de: "Freier Tag", fr: "Journ\u00e9e libre", ja: "\u4e88\u5b9a\u306a\u3057" },
  "calendar.noMeetingsPast": { en: "No meetings", ru: "\u041d\u0435\u0442 \u0432\u0441\u0442\u0440\u0435\u0447", es: "Sin reuniones", de: "Keine Meetings", fr: "Pas de r\u00e9unions", ja: "\u4f1a\u8b70\u306a\u3057" },
  "calendar.folder": { en: "Folder", ru: "\u041f\u0430\u043f\u043a\u0430", es: "Carpeta", de: "Ordner", fr: "Dossier", ja: "\u30d5\u30a9\u30eb\u30c0" },
  "calendar.noFolder": { en: "No folder", ru: "\u0411\u0435\u0437 \u043f\u0430\u043f\u043a\u0438", es: "Sin carpeta", de: "Kein Ordner", fr: "Pas de dossier", ja: "\u30d5\u30a9\u30eb\u30c0\u306a\u3057" },
  "calendar.template": { en: "Template", ru: "\u0428\u0430\u0431\u043b\u043e\u043d", es: "Plantilla", de: "Vorlage", fr: "Mod\u00e8le", ja: "\u30c6\u30f3\u30d7\u30ec\u30fc\u30c8" },
  "calendar.noTemplate": { en: "No template", ru: "\u0411\u0435\u0437 \u0448\u0430\u0431\u043b\u043e\u043d\u0430", es: "Sin plantilla", de: "Keine Vorlage", fr: "Pas de mod\u00e8le", ja: "\u30c6\u30f3\u30d7\u30ec\u30fc\u30c8\u306a\u3057" },

  "share.titleFolder": { en: "Share folder \"{name}\"", ru: "Поделиться папкой «{name}»", es: "Compartir carpeta \"{name}\"", de: "Ordner \"{name}\" teilen", fr: "Partager le dossier « {name} »", ja: "フォルダ「{name}」を共有" },
  "share.recordDesc": { en: "Give people access to this record.", ru: "Откройте доступ к этой записи.", es: "Da acceso a esta grabación.", de: "Geben Sie anderen Zugriff auf diese Aufnahme.", fr: "Donnez accès à cet enregistrement.", ja: "この記録へのアクセスを許可します。" },
  "share.folderDesc": { en: "Give people access to this folder.", ru: "Откройте доступ к этой папке.", es: "Da acceso a esta carpeta.", de: "Geben Sie anderen Zugriff auf diesen Ordner.", fr: "Donnez accès à ce dossier.", ja: "このフォルダへのアクセスを許可します。" },
  "share.sendInvite": { en: "Send invite", ru: "Отправить приглашение", es: "Enviar invitación", de: "Einladung senden", fr: "Envoyer l'invitation", ja: "招待を送信" },
  "share.sendInviteGate": { en: "Add an email address first", ru: "Сначала добавьте адрес", es: "Primero añade un correo", de: "Zuerst eine E-Mail-Adresse hinzufügen", fr: "Ajoutez d'abord une adresse e-mail", ja: "まずメールアドレスを追加してください" },
  "share.linkCaption": { en: "Anyone with the link can view. Sign-in required", ru: "Просмотр доступен всем, у кого есть ссылка. Нужен вход в аккаунт", es: "Cualquiera con el enlace puede ver. Requiere iniciar sesión", de: "Jeder mit dem Link kann ansehen. Anmeldung erforderlich", fr: "Toute personne disposant du lien peut consulter. Connexion requise", ja: "リンクを知っている全員が閲覧できます。ログインが必要です" },
  "share.copied": { en: "Copied!", ru: "Скопировано!", es: "¡Copiado!", de: "Kopiert!", fr: "Copié !", ja: "コピーしました" },
  "share.inviteSent": { en: "Invite sent", ru: "Приглашение отправлено", es: "Invitación enviada", de: "Einladung gesendet", fr: "Invitation envoyée", ja: "招待を送信しました" },
  "share.alreadyHasAccess": { en: "Already has access", ru: "Доступ уже есть", es: "Ya tiene acceso", de: "Hat bereits Zugriff", fr: "A déjà accès", ja: "すでにアクセス権があります" },
  "share.youAlreadyHaveAccess": { en: "You already have access", ru: "У вас уже есть доступ", es: "Ya tienes acceso", de: "Sie haben bereits Zugriff", fr: "Vous avez déjà accès", ja: "あなたはすでにアクセス権を持っています" },
  "share.onlyYouHaveAccess": { en: "Only you have access", ru: "Доступ только у вас", es: "Solo tú tienes acceso", de: "Nur Sie haben Zugriff", fr: "Vous seul avez accès", ja: "アクセスできるのはあなただけです" },
  "share.pending": { en: "Pending", ru: "Ожидает", es: "Pendiente", de: "Ausstehend", fr: "En attente", ja: "保留中" },
  "share.joinedViaLink": { en: "Joined via link", ru: "Вошёл по ссылке", es: "Entró por el enlace", de: "Über Link beigetreten", fr: "Rejoint via le lien", ja: "リンクから参加" },
  "share.deliveryFailed": { en: "Delivery failed", ru: "Письмо не доставлено", es: "Error de entrega", de: "Zustellung fehlgeschlagen", fr: "Échec de l'envoi", ja: "配信に失敗しました" },
  "share.deliveryFailedHint": { en: "We could not deliver the invite. Check the address and press Send invite again.", ru: "Не удалось доставить приглашение. Проверьте адрес и нажмите «Отправить приглашение» ещё раз.", es: "No pudimos entregar la invitación. Revisa la dirección y pulsa Enviar invitación de nuevo.", de: "Die Einladung konnte nicht zugestellt werden. Prüfen Sie die Adresse und klicken Sie erneut auf Einladung senden.", fr: "Nous n'avons pas pu remettre l'invitation. Vérifiez l'adresse et appuyez de nouveau sur Envoyer l'invitation.", ja: "招待を配信できませんでした。アドレスを確認して、もう一度「招待を送信」を押してください。" },
  "share.removeAccess": { en: "Remove access", ru: "Убрать доступ", es: "Quitar acceso", de: "Zugriff entfernen", fr: "Retirer l'accès", ja: "アクセスを削除" },
  "share.listFailed": { en: "We could not load who has access. Close this window and open Share again.", ru: "Не удалось загрузить список доступа. Закройте окно и откройте «Поделиться» ещё раз.", es: "No pudimos cargar quién tiene acceso. Cierra la ventana y abre Compartir de nuevo.", de: "Wir konnten nicht laden, wer Zugriff hat. Schließen Sie das Fenster und öffnen Sie Teilen erneut.", fr: "Nous n'avons pas pu charger la liste des accès. Fermez la fenêtre et rouvrez Partager.", ja: "アクセス権のあるユーザーを読み込めませんでした。ウィンドウを閉じて、もう一度「共有」を開いてください。" },
  "share.linkFailed": { en: "We could not turn the link on. Switch to Only invited and try Anyone with link again.", ru: "Не удалось включить ссылку. Переключитесь на «Только приглашённые» и попробуйте ещё раз.", es: "No pudimos activar el enlace. Cambia a Solo invitados e inténtalo de nuevo.", de: "Der Link konnte nicht aktiviert werden. Wechseln Sie zu Nur Eingeladene und versuchen Sie es erneut.", fr: "Nous n'avons pas pu activer le lien. Repassez à Invités uniquement et réessayez.", ja: "リンクを有効にできませんでした。「招待されたユーザーのみ」に戻して、もう一度お試しください。" },
  "shared.title": { en: "Shared with me", ru: "Поделились со мной", es: "Compartido conmigo", de: "Mit mir geteilt", fr: "Partagé avec moi", ja: "共有されたアイテム" },
  "shared.owner": { en: "Owner", ru: "Владелец", es: "Propietario", de: "Eigentümer", fr: "Propriétaire", ja: "オーナー" },
  "shared.folders": { en: "Folders", ru: "Папки", es: "Carpetas", de: "Ordner", fr: "Dossiers", ja: "フォルダ" },
  "shared.records": { en: "Records", ru: "Записи", es: "Grabaciones", de: "Aufnahmen", fr: "Enregistrements", ja: "記録" },
  "shared.searchPlaceholder": { en: "Search by name", ru: "Поиск по названию", es: "Buscar por nombre", de: "Nach Name suchen", fr: "Rechercher par nom", ja: "名前で検索" },
  ...
  "shared.nothingMatches": { en: "Nothing matches ‘{query}’", ru: "Ничего не найдено по запросу «{query}»", es: "Nada coincide con ‘{query}’", de: "Nichts passt zu „{query}“", fr: "Rien ne correspond à « {query} »", ja: "「{query}」に一致するものはありません" },
  "shared.tryAnotherName": { en: "Try another name, or clear the search", ru: "Попробуйте другое название или очистите поиск", es: "Prueba otro nombre o borra la búsqueda", de: "Versuchen Sie einen anderen Namen oder löschen Sie die Suche", fr: "Essayez un autre nom ou effacez la recherche", ja: "別の名前を試すか、検索をクリアしてください" },
  "shared.emptyFolder": { en: "This folder is empty", ru: "Эта папка пуста", es: "Esta carpeta está vacía", de: "Dieser Ordner ist leer", fr: "Ce dossier est vide", ja: "このフォルダは空です" },
  "shared.emptyFolderDesc": { en: "{owner} has not put anything in it yet", ru: "{owner} пока ничего сюда не положил", es: "{owner} aún no ha puesto nada aquí", de: "{owner} hat noch nichts hineingelegt", fr: "{owner} n'y a encore rien mis", ja: "{owner} はまだ何も入れていません" },
  "shared.sharedBadge": { en: "Shared", ru: "Общий доступ", es: "Compartido", de: "Geteilt", fr: "Partagé", ja: "共有中" },
  "shared.sharedByOwner": { en: "Shared by {owner}", ru: "Поделился {owner}", es: "Compartido por {owner}", de: "Geteilt von {owner}", fr: "Partagé par {owner}", ja: "{owner} が共有" },
  "shared.cannotEdit": { en: "{owner} shared this with you. You can read and export it, but not change it.", ru: "{owner} поделился этим с вами. Можно читать и экспортировать, но не менять.", es: "{owner} compartió esto contigo. Puedes leerlo y exportarlo, pero no cambiarlo.", de: "{owner} hat dies mit Ihnen geteilt. Sie können es lesen und exportieren, aber nicht ändern.", fr: "{owner} a partagé ceci avec vous. Vous pouvez le lire et l'exporter, mais pas le modifier.", ja: "{owner} があなたと共有しました。読むことと書き出すことはできますが、変更はできません。" },
  "shareView.sharedWithYou": { en: "{owner} shared a record with you", ru: "{owner} поделился с вами записью", es: "{owner} compartió una grabación contigo", de: "{owner} hat eine Aufnahme mit Ihnen geteilt", fr: "{owner} a partagé un enregistrement avec vous", ja: "{owner} が記録を共有しました" },
  "shareView.sharedFolderWithYou": { en: "{owner} shared a folder with you", ru: "{owner} поделился с вами папкой", es: "{owner} compartió una carpeta contigo", de: "{owner} hat einen Ordner mit Ihnen geteilt", fr: "{owner} a partagé un dossier avec vous", ja: "{owner} がフォルダを共有しました" },
  "shareView.signUp": { en: "Sign up", ru: "Зарегистрироваться", es: "Registrarse", de: "Registrieren", fr: "S'inscrire", ja: "新規登録" },
  "shareView.logIn": { en: "Log in", ru: "Войти", es: "Iniciar sesión", de: "Anmelden", fr: "Se connecter", ja: "ログイン" },
  "shareView.linkNotValid": { en: "This link no longer works", ru: "Ссылка больше не работает", es: "Este enlace ya no funciona", de: "Dieser Link funktioniert nicht mehr", fr: "Ce lien ne fonctionne plus", ja: "このリンクは無効です" },
  "shareView.linkNotValidDesc": { en: "The owner turned it off, or the record was deleted. Ask them for a new link.", ru: "Владелец отключил её или удалил запись. Попросите новую ссылку.", es: "El propietario lo desactivó o eliminó la grabación. Pídele un enlace nuevo.", de: "Der Eigentümer hat ihn deaktiviert oder die Aufnahme gelöscht. Bitten Sie um einen neuen Link.", fr: "Le propriétaire l'a désactivé ou l'enregistrement a été supprimé. Demandez-lui un nouveau lien.", ja: "オーナーが無効にしたか、記録が削除されました。新しいリンクを依頼してください。" },
  "shareView.goHome": { en: "Go to Transcribe To Text", ru: "Перейти в Transcribe To Text", es: "Ir a Transcribe To Text", de: "Zu Transcribe To Text", fr: "Aller à Transcribe To Text", ja: "Transcribe To Text へ" },
};
