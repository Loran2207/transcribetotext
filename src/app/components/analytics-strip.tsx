  ...
  return (
    <div className="lg:hidden mt-[22px] flex flex-col gap-[12px]">
      <button
        ...
        className="flex w-full items-center justify-between gap-[12px] rounded-[16px] bg-card border border-border shadow-sm px-[18px] py-[16px] text-left active:bg-muted/40 transition-colors"
      >
        <span className="flex min-w-0 flex-col gap-[8px]">
          <span className="text-muted-foreground" style={{ fontWeight: 600, fontSize: "13px" }}>{t("dash.tab.analytics")}</span>
          <span className="flex items-baseline gap-[8px] text-foreground">
            ...
            <span className="text-muted-foreground" style={{ fontWeight: 500, fontSize: "13px" }}>{t("dash.analytics.files")}</span>
            ...
            <span className="text-muted-foreground" style={{ fontWeight: 500, fontSize: "13px" }}>{t("dash.analytics.hrs")}</span>
          </span>
        </span>
